== GitHub Pages SEO 스타터 (도메인: www.dell-servicecenter.co.kr) ==
...
- CNAME           : GitHub Pages 커스텀 도메인 설정 파일 (한 줄: www.dell-servicecenter.co.kr)

[Search Console 등록 순서]
1) Search Console에서 속성 추가 → URL 접두어: https://www.dell-servicecenter.co.kr/
2) HTML 파일 방식으로 googleXXXX.html 다운로드 → 저장소 루트에 업로드
   (주소: https://www.dell-servicecenter.co.kr/googleXXXX.html 로 열리면 OK)
...
- 실제로 존재하는 페이지가 있다면 아래 형식으로 sitemap.xml에 추가하세요.
  <url><loc>https://www.dell-servicecenter.co.kr/contact</loc></url>
  <url><loc>https://www.dell-servicecenter.co.kr/service</loc></url>
